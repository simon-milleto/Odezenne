...
<div class='woocommerce-events-help'>
    ...
    <p>FooEvents adds seamless event and ticketing functionality to WooCommerce. The plugin adds additional event specific fields and options to the existing WooCommerce products which allows you to create branded event tickets that can be sold on your site.</p>
    
    <a href="http://www.fooevents.com/product/fooevents-express-check-in/" target="_BLANK"><img src="http://www.fooevents.com/downloads/foo-info/fooevents_express_check-in.jpg" alt="Just Launched: FooEvents Express Check-in" /></a>
    ...
    <p>WooCommerce is a WordPress plugin. FooEvents is an extension plugin that adds additional event and ticketing functionality to WooCommerce.</p> 

    <p>NB: Before installing FooEvents you must FIRST install WooCommerce</p> 

    <p>If you are new to WooCommerce it is recommended that you go through the WooCommerce documentation: <a href="http://docs.woothemes.com/documentation/plugins/woocommerce/getting-started/">http://docs.woothemes.com/documentation/plugins/woocommerce/getting-started/</a></p>
